...
def start():
    ...
    while True:
        ...
        THRUSTER_BACK_LEFT.throttle = THRUSTER_BACK_LEFT_THRUST_VECTOR.dotProduct(target) * VELOCITY_MOD
        THRUSTER_BACK_RIGHT.throttle = THRUSTER_BACK_RIGHT_THRUST_VECTOR.dotProduct(target) * VELOCITY_MOD